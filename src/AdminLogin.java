...
public class AdminLogin extends JFrame {
    ...
    public AdminLogin() {
        ...
        btn_Login = new JButton(new ImageIcon("/Users/luiz/Downloads/SIGN IN (ADMIN).png"));
        ...
        //LOGIN PAGE (USER)
        BackButton = new JButton(new ImageIcon("/Users/luiz/Downloads/LoginBtn.png"));
		...
		Register.setIcon(new ImageIcon("/Users/luiz/Downloads/RegisterBtnn.png"));
		Register.setBounds(1018, 83, 102, 41);
		contentPane.add(Register);

        //BACKGROUND====================================================================================
        
        JLabel lbl_AdminLogBG = new JLabel(new ImageIcon("/Users/luiz/Downloads/ADMIN LOGIN (1).png"));
